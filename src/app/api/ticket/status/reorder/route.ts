...
export async function PATCH(req: NextRequest) {
  ...
  // 4. Update all statuses in a transaction
  try {
    ...
    console.error('Error reordering ticket statuses:', err)
    return NextResponse.json({ error: 'Failed to reorder ticket statuses' }, { status: 500 })
  }
} 